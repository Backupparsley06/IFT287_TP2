...
public class Chambre extends HttpServlet
{
    ...
    {
        System.out.println("Servlet Chambre : POST");
    }
    ...
    {
        System.out.println("Servlet Chambre : GET id:" + request.getParameter("id").toString());
        request.getSession().setAttribute("idChambre", request.getParameter("id").toString());
